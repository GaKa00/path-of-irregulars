...
export default function GameCardView({
  ...
  const { name, type, power, description, isPlayable, isSelected } = card
  ...
  return (
    <button
      ...
      className={`
        ...
        ${baseSize}
        ${isPlayable ? 'cursor-pointer hover:-translate-y-1 hover:border-emerald-400 hover:shadow-[0_0_25px_rgba(16,185,129,0.6)]' : 'cursor-not-allowed opacity-70'}
