...
export default function MulliganPhase({
  ...
  const canConfirm = selectedCardIds.length > 0 && selectedCardIds.length <= maxSwaps
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="panel-accent mx-4 w-full max-w-2xl p-6">
        ...
        <div className="mb-6 text-center">
          <h2 className="text-2xl font-bold text-emerald-200">Mulligan Phase</h2>
        ...
        <div className="mb-6 rounded-lg border border-emerald-800/60 bg-slate-950/60 p-4">
          <p className="text-xs text-emerald-100/70">
            <strong className="text-emerald-200">How it works:</strong> Click on cards you want to
            swap. Selected cards will be returned to your deck and replaced with new ones. You can
            select up to {maxSwaps} cards.
          </p>
        </div>
